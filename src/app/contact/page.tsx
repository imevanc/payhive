    ...
    <main className="bg-white isolate px-6 py-8">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#d9f99d] to-[#16a34a] opacity-40 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
        />
      </div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="flex gap-x-4 sm:col-span-2">
            <div className="flex h-6 items-center">
              <div className="group relative inline-flex w-8 shrink-0 rounded-full bg-gray-200 p-px outline-offset-2 outline-green-600 ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out has-[:checked]:bg-green-600 has-[:focus-visible]:outline has-[:focus-visible]:outline-2">
